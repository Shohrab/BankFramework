...
public class JDialog_AddCCAccount extends CreateAccountFrame
{   
	private CCController control;
	private MainFrame parentframe;
	private String accountnumber;
   
	public JDialog_AddCCAccount(MainFrame parent)
	{
		super(parent);
		parentframe=parent;
		...
		JRadioButton_Bronze.addMouseListener(control.getradioButtonChkBoxListener());
		JRadioButton_Gold.addMouseListener(control.getradioButtonSVBoxListener());
		JButton_OK.addActionListener(control.getaddAccountForCCFrameSubmitListener(this)); //getAddAccountForCompanySubmitListener(this));
