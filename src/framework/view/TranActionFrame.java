...
public class TranActionFrame extends javax.swing.JDialog implements IMainFrame
{
	    ...
	    // {{DECLARE_CONTROLS
	 	...
	 	// }}
	    public TranActionFrame(MainFrame parent, String title, String aaccnr) {
	    	super(parent);
	    	parentframe=parent;
			accnr=aaccnr;
