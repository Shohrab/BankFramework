...
public class JDialog_AddPersonalAccount extends CreateAccountFrame {
	   BankController bcontrol;

	public JDialog_AddPersonalAccount(MainFrame parent) {
		super(parent);
		bcontrol = BankController.createinstance();
		...
		JRadioButton_Chk.addMouseListener(bcontrol.getradioButtonChkBoxListener());
		JRadioButton_Sav.addMouseListener(bcontrol.getradioButtonSVBoxListener());
		JButton_OK.addActionListener(bcontrol.getaddAccountForPeronalFrameSubmitListener(this));
