...
import framework.view.CreateAccountFrame;
import framework.view.MainFrame;

public class JDialog_AddCompanyAccount extends CreateAccountFrame {
	...
	javax.swing.JTextField JTextField_NoOfEmployee = new javax.swing.JTextField();
	javax.swing.JLabel JLabel8 = new javax.swing.JLabel();
	javax.swing.JTextField JTextField_ACNR = new javax.swing.JTextField();
	
	
	public JDialog_AddCompanyAccount(MainFrame parent) {
		super(parent);
		...
		JLabel6.setText("no Employee");
		getContentPane().add(JLabel6);
		JLabel6.setForeground(java.awt.Color.black);
		JLabel6.setBounds(12, 252, 96, 24);
		getContentPane().add(JTextField_NoOfEmployee);
		JTextField_NoOfEmployee.setBounds(84, 252, 156, 20);
		...
		JRadioButton_Chk.addMouseListener(control.getradioButtonChkBoxListener());
		JRadioButton_Sav.addMouseListener(control.getradioButtonSVBoxListener());
		JButton_OK.addActionListener(control.getAddAccountForCompanySubmitListener(this));
	...
	public String[] getAccountInfo() {
		...
		fields[5] = JTextField_NoOfEmployee.getText();
